		...
		apps.#Deployment & {
			X=metadata: {
				...
				labels: {
					...
					"app.kubernetes.io/component": _name
				}
			}
...
manifests: components.api._manifests + components.secrets._manifests + components.configmaps._manifests + components.ingress._manifests
